...
public class ResnetTest{
    ...
    public void DenseNetTest() {
        ...
        Tensor tensor31 = tf.convx(new int[]{1, 1}, new int[]{1, 1}, new Tensor("weight", new int[]{64, 3, 3}), tensor22);//64*68*68
        Tensor tensor32 = tf.addx(tensor31, tensor13);//64*68*68
        Tensor tensor33 = tf.relu(tensor32);//64*68*68

        Tensor tensor41 = tf.convx(new int[]{2, 2}, new int[]{1, 1}, new Tensor("weight", new int[]{128, 3, 3}), tensor33);//128*34*34
        Tensor tensor42 = tf.relu(tensor41);//128*34*34

        Tensor tensor51 = tf.convx(new int[]{1, 1}, new int[]{1, 1}, new Tensor("weight", new int[]{128, 3, 3}), tensor42);//128*34*34
        Tensor tensor52 = tf.convx(new int[]{2, 2}, new int[]{0, 0}, new Tensor("weight", new int[]{128, 1, 1}), tensor33);//128*34*34
        Tensor tensor53 = tf.addx(tensor51, tensor52);//128*34*34
        Tensor tensor54 = tf.relu(tensor53);//128*34*34

        Tensor tensor61 = tf.convx(new int[]{2, 2}, new int[]{1, 1}, new Tensor("weight", new int[]{256, 3, 3}), tensor54);//256*17*17
        Tensor tensor62 = tf.relu(tensor61);//256*17*17

        Tensor tensor71 = tf.convx(new int[]{1, 1}, new int[]{1, 1}, new Tensor("weight", new int[]{256, 3, 3}), tensor62);//256*17*17
        Tensor tensor72 = tf.convx(new int[]{2, 2}, new int[]{0, 0}, new Tensor("weight", new int[]{256, 1, 1}), tensor54);//256*17*17
        Tensor tensor73 = tf.addx(tensor72, tensor71);//256*17*17
        Tensor tensor74 = tf.relu(tensor73);//256*17*17
