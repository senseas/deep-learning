...
public class DenseNetTest extends Shape {
    ...
    public void DenseNetTest5() {
        ...
        Tensor tensor14 = tf.relux(tensor13);//10*136*136

        Tensor tensor21 = tf.convx(new int[]{1, 1}, 0, new Tensor("weight", new int[]{16, 5, 5}), tensor14);//16*64*64
        Tensor tensor22 = tf.relux(tensor21);//16*64*64
        Tensor tensor23 = tf.maxpoolx(2, new int[]{2, 2}, 0, tensor22);//16*32*32
        Tensor tensor24 = tf.relux(tensor23);//16*64*64

        Tensor tensor31 = tf.convx(new int[]{1, 1}, 0, new Tensor("weight", new int[]{32, 5, 5}), tensor24);//32*28*28
        Tensor tensor32 = tf.relux(tensor31);//32*28*28
        Tensor tensor33 = tf.maxpoolx(2, new int[]{2, 2}, 0, tensor32);//32*14*14
        Tensor tensor34 = tf.relux(tensor33);//32*28*28

        Tensor tensor41 = tf.demaxpoolx(2, new int[]{2, 2}, 0, tensor34);//32*28*28
        Tensor tensor40 = tf.relux(tensor41);//32*28*28
        Tensor tensor42 = tf.deconvx(new int[]{1, 1}, 0, new Tensor("weight", new int[]{16, 5, 5}), tensor40);//16*32*32
        Tensor tensor43 = tf.relux(tensor42);//32*28*28

        Tensor tensor51 = tf.demaxpoolx(2, new int[]{2, 2}, 0, tensor43);//16*64*64
        Tensor tensor50 = tf.relux(tensor51);//16*64*64
        Tensor tensor52 = tf.deconvx(new int[]{1, 1}, 0, new Tensor("weight", new int[]{10, 5, 5}), tensor50);//10*68*68
        Tensor tensor53 = tf.relux(tensor52);//16*64*64

        Tensor tensor61 = tf.demaxpoolx(2, new int[]{2, 2}, 0, tensor53);//10*136*136
        Tensor tensor60 = tf.relux(tensor61);//10*136*136
        Tensor tensor62 = tf.deconvx(new int[]{1, 1}, 0, new Tensor("weight", new int[]{3, 5, 5}), tensor60);//3*140*140
