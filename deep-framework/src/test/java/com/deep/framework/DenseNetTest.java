...
public class DenseNetTest{
    ...
    public void DenseNetTest3() {
        ...
        Tensor tensor32 = tf.relu(tensor31);//32*35*35
    ...
    public void DenseNetTest5() {
        ...
        Tensor tensor22 = tf.relu(tensor21);//32*70*70
        ...
        Tensor tensor43 = tf.relu(tensor42);//32*70*70
        ...
        Tensor tensor62 = tf.relu(tensor61);//16*140*140
