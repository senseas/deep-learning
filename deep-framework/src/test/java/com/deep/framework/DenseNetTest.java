    ...
    public void DenseNetTest5() {
        ...
        forEach(600, x -> {
            forEach(labelSet.length, i -> {
                ...
                ImageUtil.rgb2Image(Shape.reshape(tensor63.getOutput(), new Double[3][140][140], (Fill<None>) (None a) -> (double) a.getValue()), "D:/img/".concat(i + ".jpg"));
                executor.backward();
                if (600 % 50 == 0) ModeLoader.save(executor, DataLoader.BASE_PATH.concat(i + "LetNet.obj"));
            });
        });
    }
