...
public class LeNetTest {
    ...
    public void LeNetTest() {
        ...
        Tensor tensor12 = tf.relu(tensor11);//6*24
        ...
        Tensor tensor22 = tf.relu(tensor21);//16*8
        ...
        Tensor tensor34 = tf.relu(tensor33);//86*1
        ...
        Tensor tensor43 = tf.relu(tensor42);
        ...
        Tensor tensor53 = tf.relu(tensor52);//10
