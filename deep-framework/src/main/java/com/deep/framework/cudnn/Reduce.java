...
public class Reduce {
    ...
    public static void sum(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_ADD);
    }

    public static void mul(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_MUL);
    }

    public static void min(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_MIN);
    }

    public static void max(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_MAX);
    }

    public static void amax(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_AMAX);
    }

    public static void mean(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_AVG);
    }

    public static void norm1(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_NORM1);
    }

    public static void norm2(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_NORM2);
    }

    public static void mulNoZeros(Tensor input, Tensor output) {
        reduce(input, output, CUDNN_REDUCE_TENSOR_MUL_NO_ZEROS);
    }

    public static void reduce(Tensor input, Tensor output, int op) {
