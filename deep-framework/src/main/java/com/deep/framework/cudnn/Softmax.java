...
public class Softmax {
    ...
    public static void softmaxForward(Tensor input, Tensor output, int[] shape, CudaContext context) {
        // 设置输入张量描述符
    ...
    public static void softmaxBackward(Tensor input, Tensor output, int[] shape, CudaContext context) {
        // 设置输入张量描述符
        int batch_size = shape[0], channels = shape[1], height = shape[2], width = shape[3];
