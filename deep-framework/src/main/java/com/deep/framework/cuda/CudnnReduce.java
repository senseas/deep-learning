...
public class CudnnReduce {
    ...
    public static void cudnnReduceTensor4d(double[] input, int[] shape, double[] output, int[] out_shape, int op) {
        // Define input tensor
        ...
        cudnnSetTensor4dDescriptor(output_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_DOUBLE, batch_size, channels, out_shape[2], out_shape[3]);
